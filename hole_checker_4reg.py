...
def setupfile(num):
    if int(num)>partition:
        return False
    p=subprocess.Popen(['C:\\My Dropbox\\GPGlabelings\\graph program 26\\genreg.exe',''+numverts,'3', '-s'])
    p.wait()
    while os.path.isfile('C:\\My Dropbox\\GPGlabelings\\graph program 26\\'+'%0*d' % (2,numverts)+'_3_3-U.scd'):
        pass
    return os.path.isfile('C:\\My Dropbox\\GPGlabelings\\graph program 26\\'+'%0*d' % (2,numverts)+'_3_3.scd')
...
def main(num=4, superawesomecounter=0):
    ...
    with open('C:\\My Dropbox\\GPGlabelings\\graph program 26\\genreg_exports\\'+'%0*d' % (2,num)+'_3_3.scd','rb') as f:
...
##                    sys.stdout.write('\b')
            if labels!=False:
                ...
                if lnum>=6 and numholes>=3:
                    ...
                    with open('C:\\My Dropbox\\GPGlabelings\\graph program 26\\genreg_exports\\'+str(num)+'found.txt','a') as res:            
                        res.write(adj)
